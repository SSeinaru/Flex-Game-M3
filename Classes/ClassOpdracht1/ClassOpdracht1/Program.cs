...
namespace ClassOpdracht1
{
    ...
    internal class ClassStructureExercise
    {
        ...
        internal void ShowGreetingInConsole() //String
        {
        ...
        internal double DistBetweenPoints(int x1, int y1, int x2, int y2) //Coordinates
        {
        ...
        internal int MultiplyToPower2(int value) //Int
        {
        ...
        static void Main(string[] args) //Debug
        {
